        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center justify-content-end p-2">
                    <div class="dropdown">
                        <a class="btn btn-light d-flex align-items-center rounded-circle p-0 border-0" href="#" role="button" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false" style="width: 44px; height: 44px;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mt-2 shadow" aria-labelledby="userMenu">
                            <li><a class="dropdown-item" href="./pages/userProfile.php"><i class="fa fa-user me-2"></i>Profile</a></li>
...
<!-- Hero Section -->
<section id="hero_section" class="container-fluid d-flex align-items-center justify-content-center text-center text-white">
...
<div class="p-2">
    <svg width="73" height="73" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<!--  category card start  -->
    <a href="#" class="card col-lg-2">
        <div class="p-2">
            <svg width="73" height="73" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<!--  Training Center  -->
<section id="topTraining"  class="container-fluid d-flex flex-column justify-content-center align-items-center p-5 text-light">
    ...
    <div class="container row gap-3 mt-5 justify-content-center align-items-center">
        ...
        <div class="card col-lg-3 p-0">
            ...
            <div class="card-body">
                ...
                <p>
                    The University of Ghana is a premier institution offering a wide range of academic programs and research opportunities.
                </p>
            </div>
        </div>
        <!--    card end-->
    ...
    <div class="container mt-5 d-flex flex-column justify-content-center align-items-center">
        <div>
            ...
            <p style="color: #c5bdbd" class="col-lg-6">
                Bridging your skills to success! Explore TESDA programmes tailored for PUP students and take the first step towards a brighter career.
            </p>
            ...
            <a href="#" class="container-fluid row gap-3">
                <div class="col-lg-6 d-lg-flex gap-3">
                    ...
                    <div>
                        ...
                        <p style="color: #c5bdbd" >
                            TESDA Finder brings together all the necessary details about TESDA-accredited courses in one convenient platform. You can easily search and explore courses by location, specialisation, and schedule, all in one place.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-lg-flex gap-3 container-fluid-sm">
                    ...
                    <div>
                        ...
                        <p style="color: #c5bdbd" >
                            We make it easier for you to make informed decisions. Check out real feedback from fellow students about different training centres, helping you choose the right course based on trusted experiences.
                        </p>
                    </div>
                </div>
              ...
              <div class="col-lg-6 d-lg-flex gap-3">
                  <i class="fa-solid text-light fs-1 fa-certificate"></i>
                    <div>
                        ...
                        <p style="color: #c5bdbd" >
                            To ensure the credibility of the training centres, we allow you to upload your Certificate of Completion (COC). This provides a secure way to validate the legitimacy of the courses and training centres you’re interested in.
                        </p>
                    </div>
                 </div>
               </a>
        ...
        <div class="swiper-wrapper d-flex  align-items-center">
            ...
            <div class="swiper-slide shadow-sm rounded-3 h-50">
                <div>
                    ...
                    <h5>John Doe</h5>
                    <p class="mt-3">
                        "I was able to find the perfect course for me with the help of TESDA Finder. I highly recommend this platform to all students looking to enhance their skills."
                    </p>
                </div>
            </div>
            <!-- End swiper slide-->
...
<!--  About Page -->
<section id="topTraining" class="container-fluid d-flex flex-column gap-3 justify-content-center align-items-center p-5">
   ...
   <h1 class="text-center fw-bold text-light">About Us</h1>
    <div id="About_us" class="container d-lg-flex justify-content-center align-items-center">
        <p style="color: #c5bdbd" >
          ...
          Welcome to TESDA Tracker, a dedicated platform created for PUP ITECH students to simplify the search for TESDA-accredited courses and training centers.
          We understand the challenges students face when navigating TESDA’s offerings, from scattered information to difficulty finding courses that fit their skills, interests, and location. Our website bridges this gap, providing a centralized, user-friendly solution designed with students’ needs in mind.
          TESDA Tracker offers comprehensive details about TESDA programs, including course duration, prerequisites, costs, and certification opportunities.
          With intuitive filters and a clean interface, students can efficiently explore courses based on their field of study, skill level, or location. We aim to support students in pursuing technical and vocational training, empowering them with the skills needed for personal growth and future employment.
      </p>
        <img  class="img-fluid col-lg-6" src="https://www.tesdaguides.com/wp-content/uploads/2015/06/tesda-online.jpg" alt="image">
    </div>
</section>
        ...
        <div class="container text-center">
            <div class="row mb-2">
                <div class="col-12">
                    ...
                    <a href="/terms-of-service" class="text-white text-decoration-underline mx-2">Terms of Service</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
